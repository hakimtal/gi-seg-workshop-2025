...
def symmetric_lovasz(outputs, targets):
    return 0.5*(lovasz_hinge(outputs, targets, per_image=False) + lovasz_hinge(-outputs, 1.0 - targets, per_image=False))
#
#
...
#             pre = logits[:, class_nr, :, :]
#             gt = targets[:, class_nr, :, :]
#             loss += ((lovasz_hinge(pre, gt, per_image=True)) \
#                      + (lovasz_hinge(-pre, 1 - gt, per_image=True))) / 2
